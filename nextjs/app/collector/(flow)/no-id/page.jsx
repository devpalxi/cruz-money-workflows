...
function NoIdDetailContent() {
  ...
  const isPage0Valid = firstName.trim() !== '' && lastName.trim() !== '' && dob.trim() !== '';
  const isPage1Valid = showAddressFields && streetNumber.trim() !== '' && streetName.trim() !== '' && suburb.trim() !== '' && postcode.trim() !== '';
  const isPage2Valid = consentConfirmed;
  ...
  return (
    <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center gap-6 mb-4">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-ink-hi">No ID details</h1>
          </div>
          ...
          <Card padding="md" className="border-border shadow-card mb-6">
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                <span className="text-xs font-semibold text-ink-mid">Identity exception</span>
                <h2 className="text-lg font-bold text-ink-hi">No primary ID available</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="py-1 text-xs sm:text-sm text-ink-mid leading-relaxed max-h-48 overflow-y-auto">
                    You have obtained consent from your customer to the collection, use and disclosure of their personal information in accordance with your privacy policy. As no identity document is available, they consent to identity confirmation being carried out through alternative means in accordance with Australian Privacy Principles, and understand this record will be retained as part of the payout's audit trail.
                  </div>
                  <Checkbox
...
export default function NoIdDetailPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-sm text-ink-mid">Loading No ID form...</div>}>
      <NoIdDetailContent />
    </Suspense>
  );
}
