...
function PassportDetailContent() {
  ...
  // Subpage 0: Passport details
  const [passNumber, setPassNumber] = useState('N1892041');
  const [passExpiry, setPassExpiry] = useState('20/11/2030');
  ...
  useEffect(() => {
    try {
      ...
      if (saved.passNumber) setPassNumber(saved.passNumber);
      if (saved.passExpiry) setPassExpiry(saved.passExpiry);
  ...
  const handleRunVerification = () => {
    ...
    setTimeout(() => {
      ...
      if (simulatedResult === 'pass') {
        ...
        persist({ idvStatus: 'fail', docType: 'passport' });
      }
    }, 1200);
  };
      ...
      <div className="max-w-2xl mx-auto">
          ...
          <Card padding="md" className="border-border shadow-card mb-6">
            ...
            <div className="mb-5 flex items-center justify-between">
              <h2 className="text-lg font-bold text-ink-hi">Passport</h2>
            ...
            {subPage === 3 && (
              <div className="space-y-6">
                ...
                {/* Summary Block 1: Passport Details */}
                <div className="space-y-1.5">
                  <h4 className="text-[16px] font-bold text-ink-hi mb-1">Passport details</h4>
                  <div className="flex flex-col">
                    <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3 py-1.5 text-[15px]">
                      ...
                      <span className="font-bold text-ink-hi text-right font-mono">{passNumber}</span>
                      <button
                        type="button"
                    ...
                    <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3 py-1.5 text-[15px]">
                      ...
                      <span className="font-bold text-ink-hi text-right font-mono">{passExpiry}</span>
                      <button
                        type="button"
                        onClick={() => setSubPage(0)}
                        className="text-ink-mid hover:text-ink-hi underline font-semibold text-[13px] inline-flex items-center gap-1 cursor-pointer justify-self-end"
                    ...
                    <div className="grid grid-cols-[auto_1fr_auto] items-center gap-3 py-1.5 text-[15px]">
                      ...
                      <span className="font-bold text-ink-hi text-right">Australia</span>
                      <button
                        type="button"
                        onClick={() => setSubPage(0)}
                        className="text-ink-mid hover:text-ink-hi underline font-semibold text-[13px] inline-flex items-center gap-1 cursor-pointer justify-self-end"
          ...
          <div className="bg-surface-card border border-border rounded-xl shadow-modal max-w-lg w-full p-6 space-y-4">
            ...
            <div className="space-y-2">
              <div className="p-3 rounded border border-border flex items-center justify-between text-xs">
                <span className="font-mono">25/07/2026 08:30 am</span>
...
export default function PassportDetailPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-sm text-ink-mid">Loading passport details...</div>}>
